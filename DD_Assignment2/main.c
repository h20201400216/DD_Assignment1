...
#define MEMSIZE 1024 // Size of RAM
# define KERNSIZE (512)
int c=0; //Major Number
int  sectsize = 512; 
...
static int dev_open(struct block_device *x, fmode_t mode)	 
{
	int ret=0;
...
static void dev_close(struct gendisk *disk, fmode_t mode)
{
...
void device_setup(void)
{
	...
	printk(KERN_ALERT "Major Number: %d",c);
	...
	printk(KERN_INFO"DEVICE SIZE %d",device.size);	
...
void __exit blockdev_exit(void)
{	
